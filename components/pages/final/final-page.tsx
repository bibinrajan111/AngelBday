...
const messages: Record<string, string> = {
  ...
  food: "I hope this birthday feels like warm biriyani and your favorite chicken or pork dish — comforting, joyful, and full of love.",
  chocolate:
    ...
    >
      <Card className="space-y-5 p-7 md:p-10">
        <p className="inline-flex items-center gap-2 rounded-full bg-blue-500/15 px-4 py-1 text-xs uppercase tracking-[0.18em] text-blue-100">
          <Stars className="h-3.5 w-3.5" /> Final Page
        </p>
        ...
        <p className="text-base leading-7 text-slate-200 md:text-lg">
          To my Annamma — thank you for being the calm, kind, beautiful light in my days. No matter the distance, no
